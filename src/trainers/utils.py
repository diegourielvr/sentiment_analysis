...
def build_datasets(
    ...
    random_state:int = 42, undersampling:bool = True):
    
    """
    Si val_size>0, se toma el porcentaje especificado val_size
...
class EmbeddingLoader:
    def __init__(self, embeddings_path: str, type: str='w2v', binary=True):
